...
document.write('<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/plyr/3.6.3/plyr.css">');
// markdown support
...
if(dark){document.write('<style>* {box-sizing: border-box}body{color:rgba(255,255,255,.87);background-color:#272e40}.mdui-theme-primary-'+main_color+' .mdui-color-theme{background-color:#2e364c!important}</style>');}
...
function nav(path) {
    ...
    <a href="https://mohaimin99.github.io/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '@mohaimin99'}">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 36 36" enable-background="new 0 0 36 36" xml:space="preserve" class="mdui-icon" style="width: 26px;height:26px;">
        <path fill-rule="evenodd" clip-rule="evenodd" fill="#ffffff" d="M16,0A16,16,0,1,0,32,16,16,16,0,0,0,16,0ZM28.18,20.19a5.37,5.37,0,0,1-.85,1c-.27.23-.44.34-.52.34a.38.38,0,0,1-.29-.12.52.52,0,0,1-.11-.35.65.65,0,0,1,.1-.32q.1-.18.24-.45c.08-.18.16-.37.23-.58a2.26,2.26,0,0,0,.1-.71,2,2,0,0,0-.45-1.36,1.64,1.64,0,0,0-1.32-.52,6.17,6.17,0,0,0-2.63.62q-1.32.63-2.61,1.38c-.86.5-1.7.95-2.52,1.37a5.25,5.25,0,0,1-2.34.62,2.73,2.73,0,0,1-2.06-.81,2.86,2.86,0,0,1-.78-2.09,7.51,7.51,0,0,1,.17-1.64,12,12,0,0,1,.4-1.34l.39-1.14a3,3,0,0,0,.18-1,.54.54,0,0,0-.12-.39.37.37,0,0,0-.29-.12q-.37,0-1,.84a8.25,8.25,0,0,0-1.21,2.46,17.84,17.84,0,0,0-.72,2.57,11.28,11.28,0,0,0-.22,2.1.58.58,0,0,1-.12.44.65.65,0,0,1-.37.09,2.62,2.62,0,0,1-1.5-.41,1.23,1.23,0,0,1-.61-1,8.1,8.1,0,0,1,.21-1.76Q7.74,16.94,8,16c.18-.6.33-1.15.46-1.66a4.88,4.88,0,0,0,.2-1.24c0-.37-.13-.56-.4-.56a1.45,1.45,0,0,0-.93.53,5.18,5.18,0,0,0-1,1.54,12.28,12.28,0,0,0-.77,2.51,16.41,16.41,0,0,0-.32,3.39.58.58,0,0,1-.12.44.61.61,0,0,1-.37.09,2.67,2.67,0,0,1-1.5-.41,1.22,1.22,0,0,1-.6-1,14.25,14.25,0,0,1,.21-2.4c.14-.83.31-1.62.51-2.38s.39-1.45.59-2.08.37-1.14.5-1.5a.64.64,0,0,1,.61-.51,1.34,1.34,0,0,1,.64.24,3.16,3.16,0,0,1,.92,1.19,7.18,7.18,0,0,1,1-.85,6.62,6.62,0,0,1,1-.58,2.67,2.67,0,0,1,1.13-.26,1.37,1.37,0,0,1,1.16.55,4.05,4.05,0,0,1,.67,1.4,12.28,12.28,0,0,1,1.08-1,6.44,6.44,0,0,1,1.06-.68,2.65,2.65,0,0,1,1.22-.3,1.24,1.24,0,0,1,.59.17,2.58,2.58,0,0,1,.55.45,2.32,2.32,0,0,1,.39.62,1.7,1.7,0,0,1,.14.69,4.22,4.22,0,0,1-.21,1.21c-.14.46-.3.94-.48,1.46s-.34,1-.48,1.6a6.41,6.41,0,0,0-.21,1.61,1.2,1.2,0,0,0,.19.72.59.59,0,0,0,.52.28,2.59,2.59,0,0,0,1.28-.42,18.28,18.28,0,0,0,1.55-1c.56-.42,1.15-.87,1.77-1.36s1.25-.95,1.89-1.36a13.14,13.14,0,0,1,1.95-1,4.83,4.83,0,0,1,1.92-.42,2.8,2.8,0,0,1,2.21.92,3.39,3.39,0,0,1,.83,2.35,4.45,4.45,0,0,1-.36,1.8A7.87,7.87,0,0,1,28.18,20.19Z"></path>
      </svg>
    </a>`;
	$('#nav').html(html);
}
